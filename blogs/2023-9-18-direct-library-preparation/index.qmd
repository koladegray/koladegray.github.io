...
For decades on end, cell biologists have devised multiple cell sequencing methods to navigate beyond the technical difficulties of cell examination. Scientific insight into cell cultures and tissues are basically important in cancer studies and cell other forms of cellular anomalies [@Wang2017].
...
The scientific race to isolate single cell from a whole genome started properly in 2009 [@Yilmaz2012]. Based on available evidence and the increasing need for cell-based studies in microbiology, scientists were able to analyze transcriptome complexity in individual cells using the first cell whole transcriptome sequencing protocol.
...
Basically, the Microfluidics setup [@Yilmaz2012] uses a highly integrated system to achieve single cell culture and sequencing by manipulating small volumes of a few hundreds of micro-liters of fluids. As the nomenclature suggests, Microfluidics needs only a few volume of fluids in cell-based studies [@liu2020].

<br>

![Microfluidics Setup](images/image3.jpg){fig-align="center"}
...
In the laboratories and microbiological studies, Microfluidics can effectively separate biological nanoparticles from tissues samples, cell cultures and cell assemblage. In a 2016 publication of *Nature,* the future of Microfluidics was examined based on coverage and advantage in cell sequencing [@whitesides2006].
...
This explains the continued use of Mechanical Micromanipulation in many Microbiology research laboratories around the world, despite the popularity of new methods. The Mechanical Micromanipulation setup only requires the mechanical suctioning of a single cell from a cell assemblage using a capillary pipette, microscope and other supporting instruments [@ishii2010].

<br>

![Mechanical Manipulation setup](images/image2.jpg){fig-align="center"}
...
This is coming at a time when Direct Library Preparation in human medicine is increasingly becoming a topic of global scientific interest [@zhang2020a]. With time, more adoption of Direct Library Preparation method is expected to be recorded in many research facilities around the world.
